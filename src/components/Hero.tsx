...
export function Hero() {
  ...
  return (
    <section className="relative h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute bottom-32 left-6 lg:left-12 z-20 flex flex-col gap-3">
        {slides.map((_, index) => (
          <button
            key={index}
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-primary-foreground/20">
            <div className="flex items-center gap-4 py-5 px-2">
              ...
              <div>
                <p className="text-sm text-primary-foreground/70">Call Us 24/7</p>
                <p className="font-semibold">+92 318 483 3990</p>
              </div>
            </div>
            <div className="flex items-center gap-4 py-5 px-2">
              <div className="w-12 h-12 rounded-full bg-primary-foreground/10 flex items-center justify-center">
              ...
              <div>
                <p className="text-sm text-primary-foreground/70">Head Office</p>
